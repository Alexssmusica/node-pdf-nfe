...
export function getDadosAdicionais({
    ...
    titulo({ value: 'INFORMAÇÕES COMPLEMENTARES', x: 1.5, y: finalEspacoDet + 10, largura: 385.5, ajusteX, ajusteY, doc, margemEsquerda, margemTopo });
    titulo({ value: 'RESERVADO AO FISCO', x: 390, y: finalEspacoDet + 10, largura: 195, ajusteX, ajusteY, doc, margemEsquerda, margemTopo });

    const informacoesComplementares = [
        infAdic.infCpl
    ];
    
    normal({ doc, value: informacoesComplementares.join(' - '), x: 1, y: finalEspacoDet + 17.5, largura: 386, alinhamento: 'justify', tamanho: 6, ajusteX, ajusteY, margemEsquerda, margemTopo });
}
