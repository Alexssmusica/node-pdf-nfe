...
export function getRecibo({ 
    ...
    titulo({ value: 'IDENTIFICAÇÃO E ASSINATURA DO RECEBEDOR', x: 100.5, y: y + 30, largura: 374, ajusteX, ajusteY, doc, margemEsquerda, margemTopo });
    
    normal({ doc, value: 'NF-e', x: 476.6, y: y + 1.8, largura: 110, alinhamento: 'center', tamanho: 14, ajusteX, ajusteY, margemEsquerda, margemTopo });
    normal({ doc, value: 'Nº. ' + ide.nNF.padStart(9, '0').replace(/(\d{3})(\d{3})(\d{3})/, '$1.$2.$3'), x: 476.6, y: y + 22, largura: 110, alinhamento: 'center', tamanho: 10, ajusteX, ajusteY, margemEsquerda, margemTopo });
    normal({ doc, value: 'Série ' + ide.serie, x: 476.6, y: y + 31.5, largura: 110, alinhamento: 'center', tamanho: 10, ajusteX, ajusteY, margemEsquerda, margemTopo });
